...
//   } else {
//     const gizaCoords = { lat: 30.013056, lng: 31.208853 };
//     setLocation(gizaCoords);
//     setCurrentLocation("Giza, Egypt");
//     setShowCurrentLocation(true);
//     setGeoLocationEnable(true);
//     setZoneIdEnabled(true);
//     setIsSelectedByGps(true);
...
useEffect(() => {
  if (geoCodeResults?.results?.[0]?.formatted_address && coords) {
